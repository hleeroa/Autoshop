...
from backend.views import PartnerUpdate, register_account_view, LoginAccount, CategoryView, ShopView, ProductInfoView, \
...
urlpatterns = [
    ...
    path('user/register', register_account_view, name='user-register'),
